package com.cmlx.commons.excel.easynew;
...
public class ExcelUtils {
    ...
    public static <T> List<T> read(MultipartFile file, Class<T> head, String sheetName) {
        try {
     ...
     * @throws IOException 写入失败的情况
     */
    public static <T> void write(String filePath, String sheetName,
                                 Class<T> head, List<T> data) {
        // 输出 Excel
