 ...
 * @Desc -> 普通异常，不做回滚操作
 **/
public class ServiceSimpleException extends Exception implements ExceptionInterface {
    ...
    ServiceSimpleException(String throwType, int code, Map<String, String> fields, String message, String messageTemplate, Map<String, Object> messageParameters) {
        super(message);
    ...
    public static Builder copy(final ServiceSimpleException exception) {
    ...
    public static class Builder implements ServiceExceptionBuilder {
        ...
        public Exception build() {
           /* StringBuilder builder = new StringBuilder();
            ...
            return new ServiceSimpleException(throwType, code, fields, exceptionMessage, messageTemplate, messageParameters);
        }
    }
}
